...
public:
    CMainParams() {
        ...
        consensus.BIP34Height = 20000000;
        ...
        consensus.BIP66Height = 20000000; // 80d1364201e5df97e696c03bdd24dc885e8617b9de51e453c10a4f629b1e797a - this is the last block that could be v2, 1900 blocks past the last v2 block
        ...
        vSeeds.push_back(CDNSSeedData("luckycoin.org", "seed.luckycoin.org", true));
